...
'''
from content.MARS_Net.data_handle.data_processor import preprocess_input, preprocess_output, normalize_input
...
def regex_find_frame_id(filename):
    regex = re.compile(r'/(f\d+)_c') # CALEBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB
