...
from content.MARS_Net.data_handle.data_processor import aggregate_std_mean, get_std_mean_from_train_images
import content.MARS_Net.models.debug_utils
from content.MARS_Net.models.evaluate_classifier import eval_summary
from content.MARS_Net.data_handle.predict_data_generator import DataGenerator
from content.MARS_Net.data_handle.data_generator_classifier import get_data_generator_classifier, threshold_mask_area_list
...
from content.MARS_Net.models.model_builder import build_model_predict
from content.MARS_Net.visualization.CAM import visualize_feature_activation_map
...
def prediction(constants, model_name, dataset_folder, dataset_name, frame, repeat_index, img_folder, save_path):
    ...
    plot_model(model, to_file='/content/MARS_Net/models/model_plots/model_round{}_{}_predict.png'.format(constants.round_num, constants.strategy_type), show_shapes=True, show_layer_names=True, dpi=144)
...
if __name__ == "__main__":
    ...
    root_prediciton_path = "/content/MARS_Net/models/results/predict_wholeframe_round{}_{}/".format(constants.round_num, constants.strategy_type)
